...
const Footer = () => {
    return (
        <footer className="bg-black pt-20 md:pt-32 pb-12 px-6 md:px-24 border-t border-white/5">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24">
                    {/* BRAND */}
                    <div className="col-span-1 lg:col-span-1">
                        <h2 className="luxe-heading text-4xl font-semibold tracking-tight text-white mb-8">EYEMEDIA</h2>
                    ...
                    {/* SOCIAL */}
                    <div>
                        <h4 className="text-[10px] font-bold text-white uppercase tracking-widest mb-12">Social</h4>
                        <ul className="social-wrapper mt-6">
